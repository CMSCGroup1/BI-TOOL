...
public class DriverResultSet {
	...
	public static void main(String[] args){
		...
		*/
		...
		/* **********************************************Phase3 Example *****************************/
		//getSalesByEmployee example. Returns 52 rows. Can retrieve employee_name and sales_amt. I think a Bar Chart would be nice for this.
			...
			System.out.println("End getSalesByEmployee example \n\n\n\n");
			// End getSalesByEmployee example
		
	
		
		//getSalesByRegion example. Returns 3 rows. Can retrieve region and sales_amt. I think a Pie Chart would be nice for this.
			...
			System.out.println("End getSalesByRegion example \n\n\n\n");
			// End getSalesByRegion example
		
	
		//getSalesByQuarter example. Returns 4 rows. Can retrieve quarter and quarterly_sales. I think a Line Chart would be nice for this.
			...
			System.out.println("End getSalesByQuarter example \n\n\n\n");
			// End getSalesByQuarter example
			
			
			
		//getSalesTransactions example. Returns 847 rows. Can retrieve date in the format 'MM-DD' and amount. I think a Scatter Chart would be nice for this.
			...
			System.out.println("End getSalesTransactions example \n\n\n\n");
			// End getSalesTransactions example	
